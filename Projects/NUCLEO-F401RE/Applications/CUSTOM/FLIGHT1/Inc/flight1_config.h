...
#define TOF_INSTANCE               CUSTOM_VL53L3CX
...
#define RANGING_SENSOR_SET_POWER_MODE   CUSTOM_RANGING_SENSOR_SetPowerMode
#define RANGING_SENSOR_INIT             CUSTOM_RANGING_SENSOR_Init
#define RANGING_SENSOR_SET_ADDRESS      CUSTOM_RANGING_SENSOR_SetAddress
#define RANGING_SENSOR_READ_ID          CUSTOM_RANGING_SENSOR_ReadID
#define RANGING_SENSOR_GET_CAPABILITIES CUSTOM_RANGING_SENSOR_GetCapabilities
#define RANGING_SENSOR_CONFIG_PROFILE   CUSTOM_RANGING_SENSOR_ConfigProfile
#define RANGING_SENSOR_GET_DISTANCE     CUSTOM_RANGING_SENSOR_GetDistance
#define RANGING_SENSOR_START            CUSTOM_RANGING_SENSOR_Start
#define RANGING_SENSOR_STOP             CUSTOM_RANGING_SENSOR_Stop

#define POWERMODE_ON                   CUSTOM_RANGING_POWERMODE_ON   /*!< Run */
#define POWERMODE_OFF                  CUSTOM_RANGING_POWERMODE_OFF  /*!< Standby */
...
/* Firmware Id */
#define CUSTOM_FIRMWARE_ID 0x0A
