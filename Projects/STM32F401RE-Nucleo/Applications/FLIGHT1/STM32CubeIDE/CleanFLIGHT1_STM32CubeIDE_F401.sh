...
echo "/******************************************/"
"${CubeProg}" -c port=swd mode=UR reset=HWrst -d ./Release/STM32F401RE-Nucleo_FLIGHT1.bin 0x08004000 -v
echo "/******************************************/"
echo "      Dump FP-SNS-FLIGHT1 + BootLoader"
echo "/******************************************/"
SizeBinBL=`ls -l ./Release/STM32F401RE-Nucleo_FLIGHT1.bin | awk '{print $5+0x4000};'`
"${CubeProg}" -c port=swd mode=UR reset=HWrst -u 0x08000000 ${SizeBinBL} ./Release/STM32F401RE-Nucleo_FLIGHT1_BL.bin
echo "/******************************************/"
echo "                Reset STM32"
echo "/******************************************/"
