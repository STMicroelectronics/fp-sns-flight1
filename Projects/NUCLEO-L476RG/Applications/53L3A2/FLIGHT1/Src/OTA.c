 ...
 * @param None
 * @retval int8_t Return value for checking purpouse (0/1,2,3 == Error/Used IDE for compiled)
 */
uint8_t CheckBootLoaderCompliance(void)
{
  uint8_t ret= 1;

  BootLoaderFeatures = (BootLoaderFeatures_t *)0x08003F00;
  ...
  if(ret)
    ret= (uint8_t)(BootLoaderFeatures->IDE + 1);
